...
export default class Wnd extends Component {
...
const Wrapper = RoleFilter(
    DataLoader(ClassRegisterAttendance),
...
class StudentsAttendance extends Component {
    ...
    getCurrentAttendaceRecord(studentInfo) {
    ...
    render() {
        ...
        const { currStudent, data } = this.state
        const studentInfo = data[currStudent]
        const attendance = this.getCurrentAttendaceRecord(studentInfo)
