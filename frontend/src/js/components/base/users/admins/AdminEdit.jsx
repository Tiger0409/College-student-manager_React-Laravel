...
import { FormField, LabeledValue } from './../../../common/FormWidgets.jsx'
...
export default class AdminEdit extends Component {
    ...
    constructor(props, context) {
        super(props, context)
        this.state = {user: {}, userPasswordRepeat: null, id: this.props.id, isLoading: false, showConfirmDelete: false }
    ...
    beforeSave() {
        ...
        if (!id) {
            user.userMainRole = ROLE_IDS[ROLES.ADMIN]
        }
    }
    ...
    renderFormButtons() {
        ...
        let respButtonStyle = { marginLeft: 20 }
        ...
        return (
            <div style={{ marginTop: '20px' }}>
                <FormGroup>
                    ...
                    <Button className='custom' style={respButtonStyle} onClick={this.back}>Cancel</Button>
                    {deleteBtn}
                </FormGroup>
            </div>
        )
    ...
    render() {
        ...
        return (
            <div className='content-block'>
                <h2 className='block-heading'>Admin Profile</h2>
                <hr />
